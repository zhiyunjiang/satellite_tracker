...
import { createCesiumComponent, EventkeyMap } from '../core/components';
...
>({
  ...
  update(element: any, props: any, prevProps: any, context: any) {
    if (!props.data) {
      element.show = false;
  ...
  destroy(element: any, context: any) {
